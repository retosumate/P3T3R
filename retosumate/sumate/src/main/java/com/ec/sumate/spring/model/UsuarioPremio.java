...
public class UsuarioPremio implements Serializable {
	...
	private Organizacion organizacione;
	...
	public Organizacion getOrganizacione() {
		return this.organizacione;
	}

	public void setOrganizacione(Organizacion organizacione) {
		this.organizacione = organizacione;
	}
